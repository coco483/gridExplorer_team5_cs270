...
def print_red(red_list):
    for i in range(2):
        print((red_list[i][0],red_list[i][1],'R'))
...
# robo.turn_left()
# robo.set_pause(2)
# robo.on_beeper() - red cell
# robo.front_is_clear() - box (hubo cannot distinguish end of map and box walls)
...
if False:
    ...
    b1_y=3-b1_y
    b2_y=3-b2_y
    red_pos = [(5-red_pos[0][0], 3-red_pos[0][1]), (5-red_pos[1][0], 3-red_pos[1][1])]

print_box([(b1_x, b1_y), (b2_x, b2_y)])
print_red(red_pos)
